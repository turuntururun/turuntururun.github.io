...
const curry: Recipe[] = [
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/solarpowertomatocurry.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/dreameaterbuttercurry.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/heartycheeseburgercurry.png',
  ...
  },
  {
    ...
    'description': 'The milk and corn in this creamy stew have a mild, gentle sweetness.',
    'ingredients': [
      {
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/infernocornkeemacurry.png',
    'name': 'Inferno Corn Keema Curry',
    'description': 'This curry\'s infernal spiciness kicks in after the sweetness of the corn.',
    'ingredients': [
      {
        'name': 'Fiery Herb',
        'number': 27
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/dizzypunchspicycurry.png',
    'name': 'Dizzy Punch Spicy Curry',
    'description': 'A rhythmic one-two punch of sweet and spicy flavors attacks your taste buds, finishing with a hint of bitterness.',
    'ingredients': [
      {
        'name': 'Rousing Coffee',
        'number': 11
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/hiddenpowerperk-upstew.png',
  ...
  },
  {
    ...
    'description': 'A salty-sweet curry with a side of roughly cut leeks and a soft-boiled egg.',
    'ingredients': [
      {
        'name': 'Large Leek',
        'number': 27
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/roleplaypumpkaboostew.png',
    'name': 'Role Play Pumpkaboo Stew',
    'description': 'Not only does this stew look adorable, but its nutritional balance is perfect.',
    'ingredients': [
      {
        'name': 'Plump Pumpkin',
        'number': 10
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/overgrowavocadogratin.png',
    'name': 'Overgrow Avocado Gratin',
    'description': 'The rich white sauce and creamy avocado melt together perfectly.',
    'ingredients': [
      {
        'name': 'Glossy Avocado',
        'number': 22
...
const salads: Recipe[] = [
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/slowpoketailpeppersalad.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/snowcloakcaesarsalad.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/gluttonypotatosalad.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/superpowerextremesalad.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/contrarychocolatemeatsalad.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/overheatgingersalad.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/dazzlingapplecheesesalad.png',
  ...
  },
  {
    ...
    'description': 'A salad made of fresh vegetables - all harvested on Greengrass Isle.',
    'ingredients': [
      {
        'name': 'Pure Oil',
        'number': 22
  ...
  },
  {
    ...
    'description': 'The refreshing sweetness of this fruit salad soothes the soul.',
    'ingredients': [
      {
        'name': 'Fancy Apple',
        'number': 21
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/furyattackcornsalad.png',
    'name': 'Fury Attack Corn Salad',
    'description': 'When eating this salad, you should start by attacking the mound of corn.',
    'ingredients': [
      {
        'name': 'Greengrass Corn',
        'number': 9
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/defiantcoffee-dressedsalad.png',
    'name': 'Defiant Coffee-Dressed Salad',
    'description': 'A chef worked defiantly to perfect this salad with coffee dressing, tweaking the recipe again and again.',
    'ingredients': [
      {
        'name': 'Rousing Coffee',
        'number': 28
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/petalblizzardlayeredsalad.png',
    'name': 'Petal Blizzard Layered Salad',
    'description': 'The sprinkling of egg-fluffy like flower petals-has a delicate texture.',
    'ingredients': [
      {
        'name': 'Fancy Egg',
        'number': 25
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/appleacidyogurt-dressedsalad.png',
    'name': 'Apple Acid Yogurt-Dressed Salad',
    'description': 'The acidity of the apple vinegar and the yogurt make this salad temptingly tasty.',
    'ingredients': [
      {
        'name': 'Fancy Egg',
        'number': 35
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/lusciousavocadosalad.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/bulldozeguacamoleandchips.png',
    'name': 'Bulldoze Guacamole and Chips',
    'description': 'You can enjoy the crunchy, aromatic corn chips with the dip\'s smooth texture.',
    'ingredients': [
      {
        'name': 'Glossy Avocado',
        'number': 28
  ...
  },
  {
    ...
    'description': 'Slowly steamed, thick-cut ingredients form a warm salad with a fluffy texture.',
    'ingredients': [
      {
        'name': 'Plump Pumpkin',
        'number': 20
...
const desserts: Recipe[] = [
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/fluffysweetpotatoes.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/steadfastgingercookies.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/jigglypuff\'sfruityflan.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/neroli\'srestorativetea.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/sweetscentchocolatecake.png',
    'name': 'Sweet Scent Chocolate Cake',
    'description': 'Neither people nor Pokémon can resist the lure of this cake\'s sweet aroma.',
    'ingredients': [
      {
        'name': 'Honey',
        'number': 9
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/hustleproteinsmoothie.png',
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/stalwartvegetablejuice.png',
  ...
  },
  {
    ...
    'description': 'Prepared in an instant with enough heat to cause an explosion',
    'ingredients': [
      {
        'name': 'Greengrass Corn',
        'number': 15
  ...
  },
  {
    ...
    'description': 'This flaky scone is most delicious when paired with an equal amount of apple ginger jam.',
    'ingredients': [
      {
        'name': 'Fancy Apple',
        'number': 20
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/petaldancechocolatetart.png',
  ...
  },
  {
    ...
    'description': 'These macarons are perfect to give as a gift - they always make the recipient smile',
    'ingredients': [
      {
        'name': 'Soothing Cacao',
        'number': 25
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/earlybirdcoffeejelly.png',
    'name': 'Early Bird Coffee Jelly',
    'description': 'This slightly bitter coffee jelly can help wake you up faster.',
    'ingredients': [
      {
        'name': 'Rousing Coffee',
        'number': 16
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/moldbreakercorntiramisu.png',
    'name': 'Mold Breaker Corn Tiramisu',
    'description': 'This tiramisu recipe defies precedent by relying on the sweetness of corn alone.',
    'ingredients': [
      {
        'name': 'Rousing Coffee',
        'number': 14
  ...
  },
  {
    ...
    'description': 'A generously filled, bitter éclair with a cheery Clodsire design.',
    'ingredients': [
      {
        'name': 'Soothing Cacao',
        'number': 30
  ...
  },
  {
    ...
    'description': 'The sweetness from the vegetables is nice, but making eye contact with this dish will give you a fright.',
    'ingredients': [
      {
        'name': 'Plump Pumpkin',
        'number': 18
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/leaftornadosmoothie.png',
    'name': 'Leaf Tornado Smoothie',
    'description': 'This dish is full of nutrients thanks to the sun. It\'s perfect for breakfast too!',
    'ingredients': [
      {
        'name': 'Glossy Avocado',
        'number': 18
  ...
  {
    'picUrl': 'https://www.serebii.net/pokemonsleep/meals/honeygatherchocolatewaffles.png',
    'name': 'Honey Gather Chocolate Waffles',
    'description': 'A sweet treat made with bitter batter mixed with cacao, covered in heaps of honey.',
    'ingredients': [
      {
        'name': 'Honey',
        'number': 38
